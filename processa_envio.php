<?php
	...
	try
	{
	    ...
	    $mail->Username = 'igorjosielvitalino@gmail.com';                 // SMTP username
	    $mail->Password = 'suicidesilence';                           // SMTP password
	    $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
	    $mail->Port = 587;                                    // TCP port to connect to

	    //Recipients
	    $mail->setFrom('igorjosielvitalino@gmail.com', 'Web Completo Remetente');
		...
		<div class = "container">
			...
			<div class = "row">
				...
				<div class = "col-md-12">
					...
					<? if($mensagem->status['codigo-status'] == 1) { ?>
					...
					<? if($mensagem->status['codigo-status'] == 2) { ?>
